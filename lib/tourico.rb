...
require 'tourico/configuration'

# module Tourico
#   class << self
#     attr_accessor :destination_service_version, :destination_service_link, :login_name, :password, :culture, :hotels_service_version, :reservations_service_version, :location_service_version,:hotel_service_link,:reservation_service_link,:sandbox, :show_logs, :proxy_url, :open_timeout, :read_timeout
#
